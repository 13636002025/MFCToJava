...
public class Triangle extends Shape{
	...
	public Triangle(int x,int y,int w,int line,int r1,int g1,int b1,int r2,int b2,int g2)
	{
		/*OrgX = x;//原点坐标
		OrgY = y;
    	linewidth=line;
	...
	public void Draw(/*CDC*pDC*/)//绘制
	{
		...
		POINT polygon[3] = {{OrgX,OrgY-2*high/3},{OrgX-width/2,OrgY+high/3},{OrgX+width/2,OrgY+high/3}};
